...
- If the page is blocked by a cookie banner, feedback modal, or terms gate, prefer a grounded click on the highest-confidence dismiss/continue control before unrelated navigation.
